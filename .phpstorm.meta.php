...
'livewire.goals.create','livewire.goals.edit','livewire.goals.index','livewire.settings.appearance','livewire.settings.delete-user-form',
'livewire.settings.password','livewire.settings.profile','livewire.topics.avg-values','livewire.topics.create','livewire.topics.edit',
'livewire.topics.index','livewire.topics.sparkline-values','livewire.values.create','livewire.values.edit','livewire.values.index',
